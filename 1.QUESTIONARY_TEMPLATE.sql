...
(ID				NUMBER,
TEMPLATE_NAME	VARCHAR2(4000) NOT NULL);

ALTER TABLE QUESTIONARY_TEMPLATE ADD CONSTRAINT QUESTIONARY_TEMPLATE_PK PRIMARY KEY (ID);
ALTER TABLE QUESTIONARY_TEMPLATE ADD CONSTRAINT QUESTIONARY_TEMPLATE_UK UNIQUE (TEMPLATE_NAME);
