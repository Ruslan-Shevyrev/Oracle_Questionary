...
CREATE VIEW V_QUESTIONARY_QUESTION(ID, TEMPLATE_ID, TEMPLATE_NAME, QUESTION, ANSWER_TYPE_ID, ANSWER_TYPE)
AS 
SELECT q.ID, 
	   q.TEMPLATE_ID,
	...
	INNER JOIN QUESTIONARY_TEMPLATE t ON q.TEMPLATE_ID = t.ID
	INNER JOIN QUESTIONARY_ANSWER_TYPE ans_t ON q.ANSWER_TYPE_ID = ans_t.ID;